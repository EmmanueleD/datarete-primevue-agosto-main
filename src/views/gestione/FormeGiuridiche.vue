...
// SETTING VIEW
const view = {
  title: 'Forme Giuridiche',
  endpointGET: 'Options/FormeGiuridiche',
  endpointPOST: 'Options/FormeGiuridiche',
  endpointPUT: 'Options/FormeGiuridiche', // /ID
  endpointDELETE: 'Options/FormeGiuridiche' // /ID
}
