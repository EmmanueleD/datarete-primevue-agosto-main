<template>
  ...
  >
    <OptionsManager @event_refreshList="getViewData" :sidebarData="sidebarData">
    </OptionsManager>
  </Sidebar>
</template>
...
const view = {
  ...
  endpointGET: "Options/TipiDocumento",
  endpointPOST: "Options/TipiDocumento",
  endpointPUT: "Options/TipiDocumento", // /ID
  endpointDELETE: "Options/TipiDocumento", // /ID
};
