...
// SETTING VIEW
const view = {
  title: 'Livelli di Login',
  endpointGET: 'LoginLevels/LoginLevels',
  endpointPOST: 'LoginLevels/LoginLevels',
  endpointPUT: 'LoginLevels/LoginLevels', // /ID
  endpointDELETE: 'LoginLevels/LoginLevels' // /ID
}
