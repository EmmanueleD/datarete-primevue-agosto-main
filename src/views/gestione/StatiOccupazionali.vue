...
// SETTING VIEW
const view = {
  title: 'Stati Occupazionali',
  endpointGET: 'Options/StatiOccupazionali',
  endpointPOST: 'Options/StatiOccupazionali',
  endpointPUT: 'Options/StatiOccupazionali', // /ID
  endpointDELETE: 'Options/StatiOccupazionali' // /ID
}
