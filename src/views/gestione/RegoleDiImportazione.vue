<template>
      ...
      <template #content>
        ...
        <DataTable v-else :value="data" :stripedRows="true" :paginator="true" :rows="10" :resizableColumns="true"
          ...
          <Column field="AZIONI" header="Azioni">
            <template #body="{ data }">
              <Button @click="showSidebar(data)" icon="pi pi-pencil"
  ...
  <Sidebar v-model:visible="sidebarVisible" :baseZIndex="10000" position="right" class="p-sidebar-md"
    ...
    <sbRegoleImportazione :sidebarData="sidebarData" @event_refreshList="hideSidebar">
...
function confirmDelete(element) {
  confirm.require({
    message: 'Sei sicuro di voler eliminare "' + element.CAMPO + '": ' + '"' + element.VALORI + '"',
