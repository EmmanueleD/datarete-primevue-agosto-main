...
// SETTING VIEW
const view = {
  title: 'Tipi Indirizzo',
  endpointGET: 'Options/TipiIndirizzo',
  endpointPOST: 'Options/TipiIndirizzo',
  endpointPUT: 'Options/TipiIndirizzo', // /ID
  endpointDELETE: 'Options/TipiIndirizzo' // /ID
}
