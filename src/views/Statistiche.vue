<template>
  <div class="wrapper scroller">
    ...
    <!-- <div class="mb-7">
      <h3 @click="filialeVisible = !filialeVisible" class="cursor-pointer">
        REPORT FILIALE
        <i v-if="filialeVisible" class="pi pi-chevron-up ml-2"></i
        ><i v-else class="pi pi-chevron-down ml-2"></i>
      </h3>
      <Card v-if="filialeVisible">
        <template #content>
          <div id="filtri" class="mb-4">
            <div class="w-full flex justify-content-end mb-2">
              <Button
                class="p-button-text"
                @click="filtroFilialeVisible = !filtroFilialeVisible"
                :label="
                  filtroFilialeVisible ? 'Nascondi i filtri' : 'Mostra filtri'
                "
              ></Button>
            </div>
            <div
              v-if="filtroFilialeVisible"
              class="w-full flex justify-content-between flex-wrap gap-4"
            >
              <div class="flex flex-column flex-grow-1">
          ...
          <Divider class="my-4"></Divider>
          <div id="contenuto" class="w-full grid mb-2 gap-8">
            <div class="col-sm-12 col-md-5 col-lg-3">
              <DataTable :value="filiale">
                <Column field="nome" header="nome"></Column>
                <Column field="caricatoTotale" header="Caricato totale">
                  <template #body="{ data }">
                    {{
                      data.caricatoTotale.toLocaleString("it-IT", {
                        style: "currency",
                        currency: "Eur",
                      })
                    }}
                ...
                <Column
                  field="previsioneFatturato"
                  header="Previsione fatturato"
                >
                  <template #body="{ data }">
                    {{
                      data.previsioneFatturato.toLocaleString("it-IT", {
                        style: "currency",
                        currency: "Eur",
                      })
                    }}
                ...
                <Column field="liquidatoTotale" header="Liquidato totale">
                  <template #body="{ data }">
                    {{
                      data.liquidatoTotale.toLocaleString("it-IT", {
                        style: "currency",
                        currency: "Eur",
                      })
                    }}
                ...
                <Column field="fatturatoTotale" header="Fatturato totale">
                  <template #body="{ data }">
                    {{
                      data.fatturatoTotale.toLocaleString("it-IT", {
                        style: "currency",
                        currency: "Eur",
                      })
                    }}
            ...
            <div class="grid col-sm-12 col-md-6 col-lg-8"></div>
          </div>
        </template>
      </Card>
    </div> -->
