<template>
  ...
  <Sidebar v-model:visible="sidebarVisible" :baseZIndex="10000" position="right" class="p-sidebar-md"
    @hide="hideSidebar">
    <PostPutScripts @event_refreshList="getViewData" @event_HidePPScripts="hideSidebar" :sidebarData="sidebarData">
    </PostPutScripts>
  </Sidebar>
</template>
...
import PostPutScripts from '@/components/sidebars/PostPutScripts.vue'
...
// SETTING VIEW
const view = {
  title: 'Gestione Scripts',
  endpointGET: 'Script/GetScripts',
  endpointPOST: 'Script/AddScript',
  endpointPUT: 'Script/EditScript', // /ID
  endpointDELETE: 'Script/DeleteScript' // /ID
}
