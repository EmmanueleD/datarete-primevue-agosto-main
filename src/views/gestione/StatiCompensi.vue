    ...
    <Card>
      <template #content>
        ...
        >
          ...
          <Column field="ordine" header="Ordine">
            <template #body="{ data }">
              {{ data.ordine }}
            </template>
          </Column>
...
import sbStatiCompensi from "@/components/sidebars/sbStatiCompensi.vue";
...
// SETTING VIEW
const view = {
  title: "Stati compensi",
  endpointGET: "Options/StatiCompensiPratiche/GetStati",
  endpointPOST: "Options/StatiCompensiPratiche/AddStatoCompensi",
  endpointPUT: "Options/StatiCompensiPratiche/UpdateStatoCompensi", // /ID
  endpointDELETE: "Options/StatiCompensiPratiche/DeleteStatoCompensi", // /ID
};
