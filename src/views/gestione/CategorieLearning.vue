<template>
    ...
    <Card>
      <template #content>
        ...
        <DataTable
          ...
          ref="dt"
        >
          <Column field="nome" header="Ragione Sociale">
            <template #body="{ data }">
              {{ data.nome }}
            </template>
          </Column>
          <Column field="nome" header="Telefono">
            <template #body="{ data }">
              {{ data.nome }}
            </template>
          </Column>
          <Column field="nome" header="Email">
            <template #body="{ data }">
              {{ data.nome }}
            </template>
          </Column>
          <Column field="nome" header="Partita Iva">
            <template #body="{ data }">
              {{ data.nome }}
            </template>
          </Column>
  ...
  >
    <SbCategorieLearning :sidebarData="sidebarData"> </SbCategorieLearning>
  </Sidebar>
</template>
...
import SbCategorieLearning from "@/components/sidebars/sbCategorieLearning.vue";
