<template>
        ...
        <DataTable v-else :value="data" :stripedRows="true" :paginator="true" :rows="10" :resizableColumns="true"
          ...
          <Column field="stato" header="STATO">
            <template #body="{ data }">
              ...
              <span v-if="data.stato == 3">Rimborsato</span>
            </template>
          </Column>
  ...
  <Sidebar v-model:visible="sidebarVisible" :baseZIndex="10000" position="right" class="p-sidebar-md"
    @hide="hideSidebar">
    <sbNoteSpesa :sidebarData="sidebarData">
    </sbNoteSpesa>
  </Sidebar>
</template>
...
import sbNoteSpesa from '@/components/sidebars/sbNoteSpesa.vue';
